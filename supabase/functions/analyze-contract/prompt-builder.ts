...
### 8. INSTRUÇÕES CRÍTICAS PARA TAXA DE RESCISÃO:

**REGRA ABSOLUTA**: Taxa de rescisão SEMPRE = R$ 700,00 menos o desconto da taxa de instalação (quando fidelidade marcada).
